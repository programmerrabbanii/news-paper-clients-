...
const Subscription = () => {
  const freePremium = 1;
  const FamilyPlan = 14.99;
  const StudentPlan = 10.99;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="border-2 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all bg-white flex flex-col h-full">
          ...
          <ul className="mb-6 space-y-3 text-gray-700 flex-grow">
            ...
            <li className="flex items-center">
              <span className="mr-2 text-blue-600">✔</span> 15 Hours of
              Audiobook Listening/Month
            </li>
          </ul>
          <Link state={{ amount: freePremium }} to="/payment">
          ...
          <p className="text-sm text-gray-500 mt-4">
            ...
            if you haven't tried Premium before. Terms
          </p>
        </div>
        ...
        <div className="border-2 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all bg-white flex flex-col h-full">
          ...
          <ul className="mb-6 space-y-3 text-gray-700 flex-grow">
            <li className="flex items-center">
              <span className="mr-2 text-green-600">✔</span> Up to 6 Premium
              Accounts
            </li>
            <li className="flex items-center">
              <span className="mr-2 text-green-600">✔</span> Share with Family
              Members
            </li>
            <li className="flex items-center">
              <span className="mr-2 text-green-600">✔</span> Ad-Free Music and
              Audiobooks
            </li>
          </ul>
          <Link state={{ amount: FamilyPlan }} to="/payment">
            <button className="w-full bg-[#3F00E7]  text-white py-2 rounded-lg font-medium transition-all">
              Get Family Plan
            </button>
          </Link>
        ...
        {/* Card 3 */}
        <div className="border-2 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all bg-white flex flex-col h-full">
          <Link state={{ amount: StudentPlan }} to="/payment">
            <button className="bg-[#3F00E7] text-white py-1 px-3 text-sm rounded-full uppercase mb-4">
              Most Popular
            </button>
          </Link>
          ...
          <ul className="mb-6 space-y-3 text-gray-700 flex-grow">
            ...
            <li className="flex items-center">
              <span className="mr-2 text-red-600">✔</span> Exclusive Discounts
              for Students
            </li>
          </ul>
          <Link state={{ amount: StudentPlan }} to="/payment">
